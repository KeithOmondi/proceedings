...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  const navItems: NavItem[] = [
...

    {
      ...
      path: "/admin/pending-proceedings",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed top-0 left-0 z-40 h-screen w-64 bg-slate-950 text-slate-300 flex flex-col justify-between transition-transform duration-300 ease-in-out md:translate-x-0 ${
